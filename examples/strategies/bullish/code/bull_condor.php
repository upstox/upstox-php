 ...
 * Buys ATM call, sells ATM+1, sells ATM+2, buys ATM+3 call for the next weekly expiry.
 */
...
try {
    ...
    $result = $instrumentsApi->searchInstrument('Nifty 50', 'NSE', 'FO', 'CE', 'next_week', 3);
    ...
    echo 'Leg 1 long call order placed successfully. Order ID: ' . print_r($response1, true) . PHP_EOL;
    ...
    echo 'Leg 2 short call order placed successfully. Order ID: ' . print_r($response2, true) . PHP_EOL;
    ...
    echo 'Leg 3 short call order placed successfully. Order ID: ' . print_r($response3, true) . PHP_EOL;
    ...
    echo 'Leg 4 long call order placed successfully. Order ID: ' . print_r($response4, true) . PHP_EOL;
