...
These scripts place bullish options trades on Nifty 50 using the Upstox PHP SDK. Use them when you think the market is going to go **up**.
...
## Buy Call — [code/buy_call.php](code/buy_call.php)
...
**Run:**
```bash
php code/buy_call.php
```

---

## Sell Put — [code/sell_put.php](code/sell_put.php)
...
**Run:**
```bash
php code/sell_put.php
```

---

## Bull Call Spread — [code/bull_call_spread.php](code/bull_call_spread.php)
...
**Run:**
```bash
php code/bull_call_spread.php
```

---

## Bull Put Spread — [code/bull_put_spread.php](code/bull_put_spread.php)
...
**Run:**
```bash
php code/bull_put_spread.php
```

---

## Bull Butterfly — [code/bull_butterfly.php](code/bull_butterfly.php)
...
**Run:**
```bash
php code/bull_butterfly.php
```

---

## Bull Condor — [code/bull_condor.php](code/bull_condor.php)
...
**Run:**
```bash
php code/bull_condor.php
```

---

## Long Calendar with Calls — [code/long_calendar_call.php](code/long_calendar_call.php)
...
**Run:**
```bash
php code/long_calendar_call.php
```

---

## Long Synthetic Future — [code/long_synthetic_future.php](code/long_synthetic_future.php)
...
**Run:**
```bash
php code/long_synthetic_future.php
```

---

## Call Ratio Back Spread — [code/call_ratio_back_spread.php](code/call_ratio_back_spread.php)
...
**Run:**
```bash
php code/call_ratio_back_spread.php
```

---

## Range Forward — [code/range_forward.php](code/range_forward.php)
