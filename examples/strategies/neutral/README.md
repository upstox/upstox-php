...
These scripts place neutral options trades on Nifty 50 using the Upstox PHP SDK. Use them when you think the market is going to **stay in a range** — not move up or down significantly.
...
## Short Straddle — [code/short_straddle.php](code/short_straddle.php)
...
**Run:**
```bash
php code/short_straddle.php
```

---

## Short Strangle — [code/short_strangle.php](code/short_strangle.php)
...
**Run:**
```bash
php code/short_strangle.php
```

---

## Iron Butterfly — [code/iron_butterfly.php](code/iron_butterfly.php)
...
**Run:**
```bash
php code/iron_butterfly.php
```

---

## Batman — [code/batman.php](code/batman.php)
...
## Short Iron Condor — [code/short_iron_condor.php](code/short_iron_condor.php)
...
**Run:**
```bash
php code/short_iron_condor.php
```
