...
These scripts place bearish options trades on Nifty 50 using the Upstox PHP SDK. Use them when you think the market is going to go **down**.
...
## Buy Put — [code/buy_put.php](code/buy_put.php)
...
**Run:**
```bash
php code/buy_put.php
```

---

## Sell Call — [code/sell_call.php](code/sell_call.php)
...
**Run:**
```bash
php code/sell_call.php
```

---

## Bear Call Spread — [code/bear_call_spread.php](code/bear_call_spread.php)
...
**Run:**
```bash
php code/bear_call_spread.php
```

---

## Bear Put Spread — [code/bear_put_spread.php](code/bear_put_spread.php)
...
**Run:**
```bash
php code/bear_put_spread.php
```

---

## Bear Butterfly — [code/bear_butterfly.php](code/bear_butterfly.php)
...
**Run:**
```bash
php code/bear_butterfly.php
```

---

## Bear Condor — [code/bear_condor.php](code/bear_condor.php)
...
**Run:**
```bash
php code/bear_condor.php
```

---

## Long Calendar with Puts — [code/long_calendar_put.php](code/long_calendar_put.php)
...
**Run:**
```bash
php code/long_calendar_put.php
```

---

## Short Synthetic Future — [code/short_synthetic_future.php](code/short_synthetic_future.php)
...
**Run:**
```bash
php code/short_synthetic_future.php
```

---

## Put Ratio Back Spread — [code/put_ratio_back_spread.php](code/put_ratio_back_spread.php)
...
**Run:**
```bash
php code/put_ratio_back_spread.php
```

---

## Risk Reversal — [code/risk_reversal.php](code/risk_reversal.php)
