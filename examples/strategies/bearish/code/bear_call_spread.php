<?php
/**
 * Strategy: Bear Call Spread (Bearish)
 * Sells an ATM call and buys an ATM+1 call for the next weekly expiry.
 */
...
try {
    ...
    $body2->setQuantity($longCall->getLotSize());
