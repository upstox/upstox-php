...
## Call Ratio Spread — [code/call_ratio_spread.php](code/call_ratio_spread.php)
...
**Run:**
```bash
php code/call_ratio_spread.php
```

---

## Put Ratio Spread — [code/put_ratio_spread.php](code/put_ratio_spread.php)
...
**Run:**
```bash
php code/put_ratio_spread.php
```

---

## Long Straddle — [code/long_straddle.php](code/long_straddle.php)
...
**Run:**
```bash
php code/long_straddle.php
```

---

## Long Strangle — [code/long_strangle.php](code/long_strangle.php)
...
**Run:**
```bash
php code/long_strangle.php
```

---

## Long Iron Butterfly — [code/long_iron_butterfly.php](code/long_iron_butterfly.php)
...
**Run:**
```bash
php code/long_iron_butterfly.php
```

---

## Long Iron Condor — [code/long_iron_condor.php](code/long_iron_condor.php)
...
**Run:**
```bash
php code/long_iron_condor.php
```

---

## Strip — [code/strip.php](code/strip.php)
...
## Strap — [code/strap.php](code/strap.php)
