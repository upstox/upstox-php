...
try {
    ...
    // Step 3: Sell 2x the ATM+1 call
    $body2 = new \Upstox\Client\Model\PlaceOrderV3Request();
    $body2->setInstrumentToken($shortCall->getInstrumentKey());
    $body2->setQuantity($shortCall->getLotSize() * 2);
    ...
    echo 'Short call sell order placed successfully. Order ID: ' . print_r($response2, true) . PHP_EOL;
