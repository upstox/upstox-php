...
class PortfolioApi
{
     ...
     */
    public function getMtfPositions()
    {
        list($response) = $this->getMtfPositionsWithHttpInfo();
        return $response;
    }

    /**
     * Operation getMtfPositionsWithHttpInfo
     *
     * Get MTF positions
     *
     *
     ...
     */
    public function getMtfPositionsWithHttpInfo()
    {
        $returnType = '\Upstox\Client\Model\GetPositionResponse';
        $request = $this->getMtfPositionsRequest();
    ...
    /**
     * Operation getMtfPositionsAsync
     *
     * Get MTF positions
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMtfPositionsAsync()
    {
        return $this->getMtfPositionsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMtfPositionsAsyncWithHttpInfo
     *
     * Get MTF positions
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMtfPositionsAsyncWithHttpInfo()
    {
        $returnType = '\Upstox\Client\Model\GetPositionResponse';
        $request = $this->getMtfPositionsRequest();
    ...
    /**
     * Create request for operation 'getMtfPositions'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMtfPositionsRequest()
    {

        $resourcePath = '/v3/portfolio/mtf-positions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
