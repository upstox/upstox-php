...
class LoginApi
{
    ...
    protected function authorizeRequest($client_id, $redirect_uri, $api_version, $state = null, $scope = null)
    {
      ...
      /**
     * Operation initTokenRequestForIndieUser
     *
     * Init token API
     *
     * @param  \Upstox\Client\Model\IndieUserTokenRequest $body body (required)
     * @param  string $client_id client_id (required)
     *
     * @throws \Upstox\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upstox\Client\Model\IndieUserInitTokenResponse
     */
    public function initTokenRequestForIndieUser($body, $client_id)
    {
        list($response) = $this->initTokenRequestForIndieUserWithHttpInfo($body, $client_id);
        return $response;
    }

    /**
     * Operation initTokenRequestForIndieUserWithHttpInfo
     *
     * Init token API
     *
     * @param  \Upstox\Client\Model\IndieUserTokenRequest $body (required)
     * @param  string $client_id (required)
     *
     * @throws \Upstox\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upstox\Client\Model\IndieUserInitTokenResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function initTokenRequestForIndieUserWithHttpInfo($body, $client_id)
    {
        $returnType = '\Upstox\Client\Model\IndieUserInitTokenResponse';
        $request = $this->initTokenRequestForIndieUserRequest($body, $client_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Upstox\Client\Model\IndieUserInitTokenResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation initTokenRequestForIndieUserAsync
     *
     * Init token API
     *
     * @param  \Upstox\Client\Model\IndieUserTokenRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initTokenRequestForIndieUserAsync($body, $client_id)
    {
        return $this->initTokenRequestForIndieUserAsyncWithHttpInfo($body, $client_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation initTokenRequestForIndieUserAsyncWithHttpInfo
     *
     * Init token API
     *
     * @param  \Upstox\Client\Model\IndieUserTokenRequest $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initTokenRequestForIndieUserAsyncWithHttpInfo($body, $client_id)
    {
        $returnType = '\Upstox\Client\Model\IndieUserInitTokenResponse';
        $request = $this->initTokenRequestForIndieUserRequest($body, $client_id);
    ...
    /**
     * Create request for operation 'initTokenRequestForIndieUser'
     *
     * @param  \Upstox\Client\Model\IndieUserTokenRequest $body (required)
     * @param  string $client_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function initTokenRequestForIndieUserRequest($body, $client_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling initTokenRequestForIndieUser'
            );
        }
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling initTokenRequestForIndieUser'
            );
        }

        $resourcePath = '/v3/login/auth/token/request/{client_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
